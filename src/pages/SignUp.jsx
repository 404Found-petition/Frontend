...
export const SignUp = () => {
  ...
  const handleDuplicateCheck = () => {
    setIdChecked(true);
    setIsIdAvailable(username !== "used_id"); // 임시 조건
  };
          ...
          <div className="absolute w-[321px] h-16 top-[257px] left-[216px]">
            <div className="text-[12.4px] flex items-center space-x-2">
              ...
              {idChecked && isIdAvailable && (
                <span className="text-[#3F7D58] [font-family:'NanumSquareOTF-Regular'] text-[12.4px]">
                  ✔ 사용 가능한 아이디입니다.
                </span>
              )}
              {idChecked && !isIdAvailable && (
                <span className="text-[#e83232] [font-family:'NanumSquareOTF-Regular'] text-[12.4px]">
                  ❌ 이미 사용 중인 아이디입니다
                </span>
              )}
            </div>
            ...
            {confirmPassword && password && (
              <div className="absolute top-0 left-[100px]">
                {password === confirmPassword ? (
                  <p className="text-[#3F7D58] text-[12.4px] font-normal [font-family:'NanumSquareOTF-Regular',Helvetica]">
                    ✔ 비밀번호가 일치합니다
                  </p>
                ) : (
                  <p className="text-[#e83232] text-[12.4px] font-normal [font-family:'NanumSquareOTF-Regular',Helvetica]">
                    ❌ 비밀번호가 일치하지 않습니다
                  </p>
                )}
              </div>
